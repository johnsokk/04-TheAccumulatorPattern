...
#
#              for k in range(r - s): should be below count
#                  count = 0  count should be above the loop
#                  if math.cos(r) > 0: no ':'
#                      count = 1 should be count = count + 1
#                  return count return needs to be outside of the for loop
#
